...
namespace GloboTicket.TicketManagement.Application.UnitTests.Mocks
{
    ...
    {
        private static Guid ConcertGuid =>  Guid.Parse("{B0788D2F-8003-43C1-92A4-EDC76A7C5DDE}");
        private static Guid MusicalGuid => Guid.Parse("{6313179F-7837-473A-A4D5-A5571B43E6A6}");
        private static Guid PlayGuid => Guid.Parse("{BF3F3002-7E53-441E-8B76-F6280BE284AA}");
        private static Guid ConferenceGuid=> Guid.Parse("{FE98F549-E790-4E9F-AA16-18C2292A2EE9}");
        public static Mock<IAsyncRepository<Category>> GetCategoryRepository()
        {
            ...
            public static Mock<IAsyncRepository<Event>> GetEventCategoryRepository()
        {
            ...
            mockEventRepository.Setup(repo => repo.ListAllAsync()).ReturnsAsync(events);
            ...
            mockEventRepository.Verify(repo => repo.DeleteAsync(It.IsAny<Event>()), Times.Once);
            mockEventRepository.Verify(repo => repo.UpdateAsync(It.IsAny<Event>()), Times.Once);
